...
def run_simulation(num_products=10):
    ...
    # Number of products to simulate is now passed as a parameter
    # Remove the fixed num_products assignment
    # num_products = 10  # Removed this line
